	...
	writeFlashObject: function(id) {
		...
		if (navigator.plugins && typeof navigator.plugins["Shockwave Flash"] == "object") {
			...
			if (el.innerHTML != "ufo-test") {
				...
				embed.setAttribute("pluginspage", "https://web.archive.org/web/20140530141534/http://www.macromedia.com/go/getflashplayer");
				...
				var testing="HIT"+Math.random();
				el.innerHTML = '<embed type="application/x-shockwave-flash" allowScriptAccess="always" src="' + FO.movie +'"?"'+testing+'" width="' + FO.width + '" height="' + FO.height + '" pluginspage="https://web.archive.org/web/20140530141534/http://www.macromedia.com/go/getflashplayer"' + embHTML + '></embed>';
			}
		}
		else {
			var objAttrHTML = "";
			...
			el.innerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + objAttrHTML + ' width="' + FO.width + '" height="' + FO.height + '" codebase="https://web.archive.org/web/20140530141534/http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=' + FO.majorversion + ',0,' + FO.build + ',0"><param name="movie" value="' + FO.movie + '" />' + objParamHTML + '</object>';
		}
	},
...
Event.addBehavior({
  '#flash-content': function () {
	if (UFO.hasFlashVersion("8","0")) {
		if ($("flash_uri")) {
				var flash_uri = $("flash_uri").value;
				var flash_vars = "content_uri=m/"+flash_uri;
				var FO_mainnav = { movie:"m/shell.swf", width:"790px", height:"635px", majorversion:"8", build:"0", wmode:"transparent", flashvars: flash_vars };
				UFO.create(FO_mainnav, "flash-content");
		}
		$('flash_not_found').remove();
	} else {
		if ($("flash_not_found")) { $('flash_not_found').show(); }
		var body = document.getElementsByTagName('body')[0];
		if (body) {
...
function coreMetricsFlash(ugd){
	/*alert("ugd.event_id = "+ ugd.event_id+
	"\n ugd.event_category_id = "+ugd.event_category_id+
	"\n ugd.event_action_attr46 = "+ugd.event_action_attr46+
	"\n ugd.event_detail_attr47 = "+ugd.event_detail_attr47+
	"\n ugd.event_detail_sub_attr48 = "+ ugd.event_detail_sub_attr48+
	"\n ugd.event_length_attr49 = "+ ugd.event_length_attr49+
	"\n ugd.event_length_full_attr50 = "+ugd.event_length_full_attr50+
	"\n ugd.event_type = "+ugd.event_type);*/
	
	if(ugd.event_id=="episode_s2_ep29"){
		ugd.event_length_full_attr50="328.04";
	}else if(ugd.event_id=="eskimo_disco_video"){
		ugd.event_length_full_attr50="257"
	}else if(ugd.event_id=="pingu-pranks"){
		ugd.event_length_full_attr50="13.33"
	}
	if(ugd.event_action_attr46=="Launch" ||ugd.event_action_attr46=="Play"){
		ugd.event_length_attr49="0";
	}else if(ugd.event_action_attr46=="Completion"){
		ugd.event_length_attr49=ugd.event_length_full_attr50;
	}
